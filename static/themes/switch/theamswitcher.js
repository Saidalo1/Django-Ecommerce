	...
	jQuery('.patterns a').click(function(e) {
		e.preventDefault();
			...
			var name = jQuery(this).attr('name');
				jQuery('body').css('background', 'url(/static/themes/switch/images/pattern/'+name+'.png) repeat center center scroll');
...
// Style Selector function ////////////////////////////////////
	jQuery('.style a').click(function(e) {
		...
		if(name == 'green') {
			...
			jQuery('#callCss').attr('href', '/static/themes/'+name+'/bootstrap.min.css');
		}
